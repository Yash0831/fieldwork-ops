...
/**
 * Metadata for a file attached to a work order. The bytes live in S3
 * (Phase 7); {@code storageKey} is the S3 object key and
 * {@code checksumSha256} lets the upload path verify integrity.
 */
@Entity
